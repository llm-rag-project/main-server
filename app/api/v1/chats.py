...
from app.schemas.chats import ChatCreateRequest, ChatListQuery, ChatSendMessageRequest
...
async def create_chat(
    ...
    result = await service.create_chat(user_id=current_user.id, payload=payload)
    await db.commit()
